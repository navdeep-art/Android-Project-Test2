...
public class UpdateQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new DBHandler(UpdateQuestionActivity.this);
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UpdateQuestionActivity.this, "Question Updated..", Toast.LENGTH_SHORT).show();

                // launching our main activity.
                Intent i = new Intent(UpdateQuestionActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        deleteCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UpdateQuestionActivity.this, "Deleted the Question", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(UpdateQuestionActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
